% [VERIFY] abstract -- distilled from Book.md frontmatter (abstract + claims_summary).
% Numbers: 152 layers, 3.57% ensemble (Table 5), 28% relative COCO (C08/Table 8).
\begin{abstract}
...
residual nets with a depth of up to 152 layers --- $8\times$ deeper than VGG
...
with 100 and 1000 layers. The depth of representations is of central importance
for many visual recognition tasks. Solely due to our extremely deep
