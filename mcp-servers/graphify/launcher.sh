...
#
# Resolves the per-project corpus_graph.json from MINIONS_PROJECT_PORT
# and execs `python -m graphify.serve` from this directory's .venv.
#
# If the graph.json does not yet exist (project freshly created, Noter has
...
GRAPH_PATH="$REPO_ROOT/project_${PORT}/branches/shared/exploration/corpus_graph.json"
