...
def _build_eacn_role_loop_prompt(
    ...
    return (
        ...
        "       pass the plan's id in `mos_draft_append(resolves_pending=[<id>])`\n"
        "       so the plan node is replaced by its result and disappears.\n"
        "       The Draft records what happened, not what was intended — a\n"
        "       drained plan must NOT linger as a 'verified question'.\n"
