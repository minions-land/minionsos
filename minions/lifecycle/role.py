...
_BOUNDARY_TEXT: dict[str, str] = {
    "gru": (
        ...
        "Cross-role artefacts go to `branches/main/<subdir>/` via "
    ...
    "ethics": (
        ...
        "`branches/main/ethics/`; curate the Book under `branches/main/book/`; "
        "flush the Draft at `branches/main/draft/draft.json`. Do NOT publish into "
        "`branches/main/reviews/` — reserved for `mos_review_run`.\n"
    ...
    "expert": (
        ...
        "cross-role handoffs to `branches/main/handoffs/` via "
        "`mos_publish_to_shared`; experiment bundles to "
        "`branches/main/exp/exp-<id>/`.\n"
