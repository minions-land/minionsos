...
- During `run-review-round` if `branches/main/reviews/summaries/round-<n-1>.md` exists.
...
- **Pass B (previous summary only)** — read `branches/main/reviews/summaries/round-<n-1>.md`. Do not read older summaries, older round directories, current `reviewer-<i>.md`, current `fresh.md`, or current `consolidated.md`.
...
1. **Pass B: read previous summary only.** `branches/main/reviews/summaries/round-<n-1>.md`. Nothing else.
