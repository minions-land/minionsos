...
3. **Task market is the collaboration bus.** Substantive Role-to-Role coordination happens as EACN3 tasks. Do not hide work intent in private files, host conversation, the Scratchpad, or Gru context; publish a task or bid on the one you received.
...
- **Hiding work as side channels.** Host conversation, the Scratchpad, and shared files are not EACN-visible. If another Role needs to act, publish a task or send a message — do not assume they will "see" your Scratchpad node or file change.
