...
2. **Locate the prior rolling summary if any.** If this is round ≥ 2, check `artifacts/reviews/summaries/round-<n-1>.md`. Pass its path as `prior_summary_path` so Pass B / Pass C can run.
