...
6. **Verify reproduction.** Run the commands yourself (or dispatch to Experimenter) in a clean environment. If numbers don't match the paper exactly, either fix the snapshot or honestly document the gap.
