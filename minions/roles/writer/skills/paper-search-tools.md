...
3. **Separate paper classes.** Maintain background, closest-related, dataset/benchmark, methodology, and contrasting-work groups in `branches/writer/paper/references/` or `branches/writer/paper/notes/`.
