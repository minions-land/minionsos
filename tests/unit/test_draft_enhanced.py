"""Tests for new Draft features: communities, god_nodes, edge strength, token budget."""
...
class TestEdgeStrength:
    ...
    def test_path_prefers_strong_edges(self):
        ...
        result = draft.mos_draft_path(target_node_id="R-001")
...
class TestCommunities:
    def test_empty_dag(self):
        result = draft.mos_draft_communities()
...
class TestGodNodes:
    def test_empty_dag(self):
        result = draft.mos_draft_god_nodes()
    ...
    def test_identifies_hub(self):
        ...
        result = draft.mos_draft_god_nodes(top_n=3)
...
class TestTokenBudget:
    def test_query_respects_budget(self):
        ...
        result = draft.mos_draft_query(max_tokens=200)
    ...
    def test_query_no_truncation_when_small(self):
        ...
        result = draft.mos_draft_query(max_tokens=2000)
