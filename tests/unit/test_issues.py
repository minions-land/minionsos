...
def _make_args(**overrides: object) -> IssueReportArgs:
    base = {
        "title": "mos_dag_append rejects valid edges",
        "severity": "P1",
        "component": "tool",
        "summary": (
            "Calling mos_dag_append with a hypothesis->experiment edge raises ValidationError."
        ),
        "steps_to_reproduce": ["call mos_dag_append with edges=[{...}]"],
